                ...
                <table class="table">
                    ...
                    <?php foreach ($categorys as $key => $value) { ?>
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php echo $value->getMaTloai(); ?>
                                </th>
                                <td>
                                    <?php echo $value->getTenTloai(); ?>
                                </td>
                                <td>
                                    <a href="edit_category.php?id=<?php echo $row['ma_tloai'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <a href="process_remove_category.php?id=<?php echo $row['ma_tloai'] ?>" onclick="return confirm('Bạn có muốn xóa thể loại không?')">
