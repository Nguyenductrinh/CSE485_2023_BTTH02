...
CREATE TABLE `article` (
  ...
  `song_name` varchar(100) COLLATE utf8_vietnamese_ci NOT NULL,
  `category_id` int(10) UNSIGNED NOT NULL,
  `summary` text COLLATE utf8_vietnamese_ci NOT NULL,
...
INSERT INTO `article` (`id`, `title`, `song_name`, `category_id`, `summary`, `content`, `author_id`, `date`, `image`) VALUES
...
ALTER TABLE `article`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ma_tgia` (`author_id`),
  ADD KEY `ma_tloai` (`category_id`);
